...
The ``retirement consumption puzzle'' refers to the repeated empirical finding that expenditure often drops when people retire, despite standard life-cycle and permanent-income models predicting relatively smooth consumption over time. In the canonical framework, households accumulate during working life and then gradually decumulate in retirement while maintaining living standards \parencite{ando1963lifecycleHypothesis}. In practice, many households appear to reduce spending at retirement and draw down wealth more slowly than these models would imply.
...
For this project, the implication is that spending assumptions in the simulation framework should be flexible rather than fixed. A model that allows for a consumption floor, wealth-responsive discretionary spending, and heterogeneous shocks is likely to be more realistic for New Zealand retirees than a deterministic decumulation rule. This perspective is also consistent with survey evidence that retirees often prioritise precautionary balances and financial security over rapid wealth drawdown \parencite{alonso-garcia2022saving}.
