...
The behaviour of retirees in terms of their spending patterns and financial concerns is often referred to as the ``retirement consumption puzzle'' or the ``retirement spending puzzle''. This refers to the observation that many retirees reduce their consumption significantly at the point of retirement, and that they do not spend downtheir wealth as much as traditional economic models would predict. 

The standard economic model of retirement for some time, which is based on the life-cycle hypothesis, predicts that retirees will spend down their wealth over time, with wealth peaking at retirement and then declining as they age \parencite{ando1963lifecycleHypothesis}. The idea is that retirees will try to smooth their consumption over their lifetime, which means that consumption will be relatively stable, while wealth will decline as they draw down on their savings. However, the evidence suggests that many retirees do not follow this pattern, and instead maintain or even increase their wealth during retirement (if possible). 



\textcite{alonso-garcia2022saving} conduct a survey of Dutch and Australian retirees to understand their saving preferences after retirement. While neither country is a perfect analogue for New Zealand, they do share some important characteristics with it. Australia is arguably the most culturally similar to New Zealand, addtionally, they also have a super-annuation savings system that shares some important features with New Zealand's KiwiSaver system. The Netherlands, on the other hand, garantees a basic pension to all retirees, which is more similar to New Zealand's NZ Super system. The Dutch also have occupational pension schemes, which are not common in New Zealand. As noted before, the New Zealand retirement will increasingly resemble the Australian system, so understanding the concerns of Australian retirees is likely to be particularly relevant for understanding the concerns of future New Zealand retirees. 
