...
\author{Callum Davidson in partnership with Consilium NZ LTD}
...
Asset allocation is the process of determining how to distribute an investor's wealth across different investments so that the portfolio meets the investor's objectives and risk tolerance. 
...
This report will also principally focus on the optimal allocation of capital to three broad asset classes: equities, bonds, and cash. Although some investors and advisors spend considerable energy selecting particular securities or funds, \textcite{ibbotsonAssetAllocation} find that roughly 90\% of the variation in fund returns is explained by the allocation to major asset classes. Therefore, allocation to these asset classes is arguably the primary driver of a portfolio's long-term behaviour. Furthermore, the types of investment products that are typically used for retirement investing in New Zealand (e.g., KiwiSaver, managed funds, and other pooled investment vehicles) are usually structured around these broad asset classes, rather than individual securities. The investor's typically excerice little control over the specific securities held in their portfolio, and instead choose from a limited set of pre-defined strategies that allocate to different amounts of ``Growth'' (i.e equities) and ``Income'' (i.e. Bonds, Cash) assets as a proxy for the riskiness of the portfolio. These asset classes will be constructed similarly to the way they are in Consilium's model portfolios, with Growth assets consisting of a diversified mix hedged and unhedged global equities, and Bonds and Cash consisting of a diversified mix of hedged global bonds and domestic bonds and cash. 

The goal of this report is to provide a review of the literature on lifecycle asset allocation and the retirement settings in New Zealand. We will then develop a simulation and optimization framework to evaluate different retirement asset allocation strategies. This simulation and optimisation framework is the key contribution of this report, and will allow us to test the performance of different strategies under a range of assumptions and scenarios. We will demonstrate the flexibility of this framework by applying it a hypothetical New Zealand retiree household, and use it to evaluate the performance of different asset allocation strategies. Finally, we will examine the sturcture and performance of the optimal strategies that emerge from our framework, and discuss the implications for retirement planning and policy design for Consilium and New Zealand more broadly.

\subsection{The Lifecylce Model of Wealth and Lifetime Asset Allocation}
\label{sec:glidepath_literature}

A foundational concept in this area is the lifecycle model of wealth. Developed by \textcite{modigliani1954utility} and expanded by \textcite{merton1969lifetime}, the lifecycle model posits that individuals make consumption and saving decisions over their lifetime to smooth consumption in response to changes in income, wealth, and spending needs. In essence, the lifecylce model suggests that individuals should save during their working years but only insofar as they need to in order to meet their consumption needs in retirement. In other words, they shouldn't over-save and under-consume during their working life. Equally, they should draw down on their wealth to maintain a similar level of consumption as a retiree as they did while working. The optimal wealth ``trajectory'' over the lifecycle is therefore a hump-shaped curve, with wealth peaking around the point of retirement and then declining as the individual draws down on their savings to fund their spending needs. The perfect lifecycle model is a theoretical construct and, in practice, individuals face a range of uncertainties and constraints that can affect their ability to save and spend optimally over their lifetime. These include uncertainty about future income, health, longevity, and investment returns, which we will return to later in this report. Despite this, the lifecycle model introduces us to two key risks that are particularly relevant for retirement planning. The first is longevity risk, which is the risk that an individual will outlive their savings and be unable to fund their spending needs in retirement. The second is the opposite risk, which is the risk that an individual will die before they have fully consumed their accumulated wealth. In the first case, the individual may face financial hardship in later life, while in the second case, the individual has oversaved and underconsumed, meaning they may have endured a lower standard of living than they otherwise could have enjoyed had they been able to spend more of their wealth during their lifetime. 

A well performing allocation strategy is one that maximises the investor's expected welfare, which is a function both of the expected return and the protection against adverse outcomes. Conventional wisdom suggests that the optimal risky-asset share of a investor's portfolio should decline over the lifecycle. An explaination for this is that the investor's risk tolerance declines with age, as they have less time to recover from potential losses. \textcite{BODIE1992427} arrives at this conclusion through a lifecycle model of wealth and consumption, which incorporates the idea of human capital. Human capital is the present value of an individual's future labor income, which \textcite{BODIE1992427} treats as a safer, bond-like asset. In this model, a younger investor can invest more heavily in risky assets because their net position is dominated by human capital, which is relatively safe. As the investor ages and their human capital declines, they should reduce their exposure to risky assets and increase their allocation to safer assets like bonds.

Based in a understanding of these principles, a large number of intuitively appealing, easy-to-communicate age-based rules have emerged that have become the industry standard for retirement investing. These include the various age-in-bonds rules (e.g. the 120-minus-age rule), and target-date funds which are investment products that automatically adjust the asset allocation over time according to a predetermined schedule. This asset allocation trajectory over a lifetime is often referred to as a ``glidepath''. This idea that risk should decline with age and that the glidepath should be declining is widely accepted in the financial industry, and has been developed into a myriad of financial products, typically known as ``target-date funds'' (TDFs). A local example is the SuperLife Age Steps strategy, which automatically adjusts the allocation to Growth and Income assets based on the investor's age, with the proportion of Growth assets declining as the investor gets older. The asset allocation is shown in Figure \ref{superlifeAllocation}.
...
Although widely recommended and popular, the academic literature has not reached a consensus on the optimal shape of the glidepath. Different studies reach different conclusions about whether risk should decline, rise, or remain constant over time, and whether the optimal strategy differs between the accumulation and decumulation phases. What emerges from the literature is a complex and unresolved debate about the optimal shape of the glidepath, with different studies reaching different conclusions about whether risk should decline, rise, or remain constant over time, and whether the optimal strategy differs between the accumulation and decumulation phases. There are essentially five main shapes that have been proposed for the optimal glidepath (see Figure \ref{glidepathShapes}):
...
The standard industry recommendation is that investors decrease their risk exposure as they age, continuing to reduce risk even after retirement (DE). This approach appears in investment textbooks \parencite[e.g][]{bodie2023investments, bengen1996asset} and is widely recommended by financial advisers and retirement planning tools \parencite{choi2022popular}. A review of U.S target date funds (TDFs) by \textcite{dolvin2010asset} find that most follow some form of declining-risk structure, often resembling a 120-minus-age equity rule. For a domestic example, take the SuperLife Age Steps allocation profile shown in Figure \ref{superlifeAllocation}. At one point a declining-risk glidepath was considered as part of potential reforms to the United States Social Security system under the George W. Bush administration \parencite[see][]{shiller2005life, shiller2006lifecycleSocialSecurity}.

However, declining-risk glidepaths have been challenged by a substantial body of academic work, and the post-retirement period in particular is a site of active and unresolved disagreement in the literature. Early work by \textcite{merton1969lifetime} shows that the optimal risky-asset share is constant through time. There are many simplifying assumptions in this result, but probably the most significant for lifecycle investing is that the investor's spending needs are fixed proportion of the investor's wealth, such that the investor adjusts their spending in response to changes in wealth. This is a strong assumption, and it is often not true in practice. In reality, this is not true as diferential longevity risk, health shocks, and changing preferences all mean that spending needs are uncertain and evolve over time. Futhermore, this fixed-proportion of wealth does not allow the investor to optimally consume according to the lifecycle model, which wants to see the investor optimally draw down on their wealth to zero at the end of their life. If the investor is spending a fixed proportion of their wealth, they will never draw down to zero, and will be decreasing their spending over time as their wealth declines (which violates the consumption -smoothing principle of the lifecycle model). 

Responding to the aforementioned Bush-era proposal, \textcite{shiller2005life} and \textcite{shiller2006lifecycleSocialSecurity} find that declining-equity glidepaths often fail to outperform a 100\% equity strategy. Further work by \textcite{estrada2014glidepath, estrada2015retirement} finds that declining-risk strategies tend to underperform constant-risk alternatives or even contrarian rising-risk strategies (RE, U-shaped) across a wide range of countries and historical periods.

The reasons for this disagreement are complex, but a key fault seems to lie line in the choice of methodology for generating asset return scenarios, modelling risk tolerances, and modelling investor behaviour. On the asset return front, authors use many different approaches, including historical rolling periods, Monte Carlo simulation with IID returns, and other bootstrapping methods. These methodological choices are likely to have a significant impact on the results and conclusions drawn about the optimal glidepath shape. Studies generating return scenarios using Monte Carlo simulation with IID returns tend to find support for U-shaped glidepaths with rising equity in retirment. This means a declining-risk strategy during the accumulation phase with reduced equity exposure around the point of retirement, and then rising again during the retirement/decumulation phase. 
...
\begin{enumerate}
  ...
  \item What (if any) asset allocation strategies outperform fixed asset allocation strategies, and how do they perform under different modelling assumptions?
\end{enumerate}

We make three contributions relevant to the New Zealand context and Consilium's position on this topic. First, we review the New Zealand-specific literature on retirement and retirement policy, and outline the needs and behaviour of New Zealand retirees. Second, we develop a method for simulating lifetime wealth and spending paths for a representative New Zealand retiree, calibrated to the institutional context of New Zealand Superannuation and KiwiSaver. A secondary goal of this is to improve on the current model used by Consilium in the GPS and other areas. Third, we will develop an optimistation framework to create dynamic asset allocation strategies and compare their performance under different modelling assumptions.
...
\begin{itemize}
  \item \textbf{Winter Energy Payment:} a universal supplement paid automatically to NZ Super recipients from 1 May to 1 October each year. The 2026 rate is \$20.46 per week for single people and \$31.82 per week for couples and people with dependants \parencite{winz2026benefitRates}.
...
\subsection{Patterns of Spending Among Retirees in New Zealand and Abroad}
...
\subsubsection{Non-Decumulation, Bequests, and Precautionary Savings}

The second empirical departure from the LCH is non-decumulation, the fact that many retirees do not run down their savings as the model predicts, and that a notable share die with substantial wealth intact. Financial planners often describe this as a form of risk, namely that a retiree may preserve so much wealth that they die having ``underconsumed'' relative to what was feasible. A common explanation for this phenomenon is that retirees intentionally preserve wealth to leave bequests to their heirs \parencite[e.g.][]{hurd1987savings}. In this view, retirees are not underconsuming, but are instead consuming optimally while also deriving utility from leaving a bequest to their heirs. However, the empirical evidence for intentional bequest motives is weak. \textcite{alonso-garcia2022saving} find that Australian and Dutch retirees have little to no intentional bequest motive outside provision for a surviving spouse, and that the observed pattern of non-decumulation is more consistent with saving for uncertain future costs, such as aged care or health shocks. This motive is often referred to as a ``precautionary'' motive, and is distinct from a bequest motive in that the utility of leaving a bequest is not derived from the act of leaving a bequest itself, but rather from the desire to avoid the risk of being unable to cover future costs.

Precautionary motives are well-supported empirically. \textcite{denardi2010differential} show that exposure to uncertain health and long-term care costs explains much of the observed non-decumulation in the United States. Similarly, \textcite{banks2016lifeCycle} find that healthcare costs drive higher late-life spending among U.S. retirees relative to those in the U.K. with broader public coverage. New Zealand's system is mixed: most core medical services are publicly funded, but long-term care such as assisted living and memory care can involve substantial out-of-pocket costs \parencite{nzgov2026residentialCare}. \textcite{riig2024spending} conclude that precautionary motives in New Zealand are likely weaker than in the United States, but stronger than in countries such as France and Germany with more comprehensive public provision, placing New Zealand alongside the United Kingdom in a mixed-funding model. However, aged care remains a potentially significant late-life expense.
...
The importance of homeownership is expected to increase over time. \textcite{riig2024spending} note that homeownership among New Zealanders aged 65 and over is projected to fall from around 80 percent today to approximately 60 percent by 2048, as younger cohorts face higher barriers to entry in the housing market. This shift implies that expenditure benchmarks calibrated on the current cohort of retirees (who benefit from unusually high ownership rates) will understate spending requirements for future generations, particularly with respect to housing costs.
...
With the exception of the continuous-time approach pioneered by \textcite{merton1969lifetime}, the majority of the literature on simulating lifetime wealth trajectories uses discrete-time approaches that model the investor's wealth at regular intervals, such as annually or monthly \parencite[e.g.][]{anarkulova2025beyond, Makinen2024,estrada2014glidepath}. This approach is far easier to implement and makes fewer assumptions about the underlying return process than the continuous-time approach, which relies on strong assumptions about the return process (for example, that returns are normally distributed and independent over time) that are not supported by empirical evidence.
...
Note that we constrain \(\pi_{t+1} \ge -w_t\), such that the investor cannot withdraw more than their current wealth balance (that is, cannot go into debt). This is a realistic constraint for a typical retiree. While retirees may have access to credit or other sources of funds that could allow them to temporarily withdraw more than their current wealth balance, this is not a sustainable strategy and would likely lead to financial distress in the long run.
...
NZ Super provides a guaranteed, inflation-linked income floor from age 65. The income received from NZ Super is calculated within our framework as follows in Equation \ref{nz_super_income}:
\begin{equation}\label{nz_super_income}
y_t = y_0 \times s_t
\end{equation}

Where \(y_0\) is the initial NZ Super payment for the household at age 65 (see Table \ref{tab:nzSuperRates}), and \(s_t\) is the cumulative inflation factor at time \(t\) since retirement.
...
\begin{equation}\label{interpolated_allocation}
...
For the purposes of this report, we are interested in simulating a household consisting of two retirees of the same age. We simulate the wealth trajectories of this household over a 35-year retirement period, from age 65 to age 100. Our retirees have an assumed real consumption floor equal to the ``No Frills Metro'' expenditure as defined by \textcite{matthews2025guidelines}. The couple also have a desired spending target equal to the ``Choice Metro'' expenditure, which declines by 2\% in real terms each year (until it reaches the consumption floor at around age 90), consistent with the data and recommendations presented in \textcite{riig2024spending}. In this setup, our retiring couple know approximately how much they want to spend in retirement, and how little they absolutely need. They are primarily concerned with the risk of running out of money. Spending above the floor is valuable to them, but they are not willing to take on substantial additional risk to achieve it. This is a common situation for many retirees, who have a good sense of their desired lifestyle in retirement and the minimum they need to get by, and are primarily concerned with ensuring that they do not run out of money.
...
The optimisation of \(\theta\) is central to our analysis, as it determines the asset-allocation strategy that maximises our chosen risk measure over simulated wealth trajectories. \textcite{Makinen2024} use an adjoint method to compute gradients of the risk measure with respect to policy parameters, enabling efficient optimisation in high-dimensional parameter spaces. This approach is powerful, but complex to implement, and it tends to restrict objective functions to those that depend only on terminal wealth. For this reason, we adopt a more direct approach based on automatic differentiation in Python using PyTorch \parencite{pytorch}. This allows us to compute gradients without deriving adjoint equations and to use risk measures that depend on the full wealth trajectory rather than terminal wealth alone. The trade-off is lower computational efficiency than an adjoint implementation at high dimensionality, in exchange for greater flexibility and simpler implementation. Our simulation framework is fully differentiable, so we optimise policy parameters directly with a gradient-based method. We initialise each optimisation run at 100\% cash (as in \textcite{Makinen2024}). We also tested alternative initialisations, including random initialisation and initialisation based on the optimal fixed-allocation strategies discussed in Section \ref{sec:fixed_allocation_strategies}. We found that initialisation choice did not materially affect final results.

To enforce the allocation constraints in Equation \ref{allocation_constraints} (non-negativity and weights summing to at most one) during gradient descent, we project policy parameters onto the feasible set after each gradient update using the simplex projection algorithm of \textcite{duchi2008efficient}. This efficient \(\mathcal{O}(n \log n)\) procedure computes the Euclidean projection onto the constraint set, ensuring feasibility while staying as close as possible to the unconstrained update. A detailed description is provided in Appendix \ref{appendix:simplex_projection}. We use the Adam optimiser \parencite{adam}, which adaptively adjusts the learning rate for each parameter using first- and second-moment gradient estimates. In our setting, this is especially useful in flat regions of the policy-response landscape, which are common for high-wealth retirees and for states near the end of the simulation horizon. To keep updates tractable in this constrained problem, we also project gradients onto the feasible set before applying Adam, ensuring that updates proceed in constraint-respecting directions. Without this step, Adam can become stuck at sub-optimal points where unconstrained gradients point outside the feasible region. Details of this gradient-projection step are provided in Appendix \ref{appendix:adam_projected_gradients}.
...
\begin{figure}[ht!]
    ...
    \caption{Autocorrelation function (ACF, left) and partial autocorrelation function (PACF, right) of the annual CPI inflation rate for the two block-bootstrapped generators. Both bootstrapped series exhibit a substantial positive lag-1 ACF and a PACF that drops sharply after lag 1, consistent with an AR(1) inflation process. This persistence implies that a single bad inflation year predicts several further years of elevated inflation.}
...
\subsubsection{Inflation Risk and the Future of New Zealand Superannuation}

The simulation framework used in this report assumes that retirees receive New Zealand Superannuation as a guaranteed, inflation-indexed income stream. This is an important modelling choice because it materially changes the risk profile of retirement. In our setting, this has two effects. First, it lowers the probability that a retiree will exhaust their savings before the end of life. Second, it provides a source of income that is not tightly coupled to financial market performance, which gives retirees a greater ability to absorb bad market outcomes without having to sharply reduce consumption.

The future of NZ Super has become a recurring topic in public debate, particularly as population ageing places pressure on the public pension system. While no major reform has yet been enacted, there has been increasing discussion of measures such as means-testing, tighter eligibility criteria, or a gradual shift toward a greater role for private savings through KiwiSaver. These debates are often framed as fiscal or intergenerational issues, but for retirement asset allocation they also matter directly as any policy change that weakens the inflation-linked support provided by NZ Super is likely to increase the exposure of retirees to inflation and market risk.

We did not explicitly simulate the counterfactual of a future NZ Super system with reduced coverage, means testing, or lower indexation. Nevertheless, our results strongly suggest that the consequences would be material. If the public pension floor were weakened or its inflation linkage were reduced, retirees would need to rely more heavily on private wealth to sustain real consumption in later life. This would likely increase the optimal equity exposure for many households, particularly those with moderate wealth and/or high spending needs, while also increasing the sensitivity of retirement outcomes to bad inflation episodes and adverse market sequences. In other words, the public pension system effectively provides an inflation-hedging channel that is not easily replicated by private assets in a low-risk portfolio. Removing or reducing that channel would therefore have a substantial effect on retirement welfare and on the appropriate design of private asset-allocation strategies.

This matters because the long-run objective is not simply to maximise portfolio return. It is to ensure that retirees can maintain a stable standard of living throughout retirement under a range of inflation, market, and longevity outcomes. A policy environment in which NZ Super becomes less certain, less generous, or less well indexed would therefore raise not only fiscal risk, but also retirement-planning risk. In that setting, the role of private savings and inflation-sensitive investment decisions becomes more important, and the need for robust, wealth-aware allocation policies becomes more acute. It's universality is also important, as it is a garanteed income stream for all New Zealanders, regardless of the course of their private savings or investment decisions. Removing or weakening that guarantee would therefore have the effect of increasing the uncertainty and risk faced by retirees and make planning for retirement more complex and challenging.


\subsection{Basic Mathematical Intuition for the Hail-Mary Zone} 

The fact that below a certain wealth threshold the optimal strategy is to maximise expected return, even at the cost of increased risk, is not something that has been widely discussed in the literature relating to this problem. The explanation by \textcite{pfau2014rising} for why rising-equity glidepaths emerge in their analysis comes close to this understanding, but does not explicitly identify the hail-mary zone as a distinct region of the optimisation landscape, likely because their analysis is based on a single initial wealth level and so does not consider the full implications of wealth and spending. In this section we provide a simple mathematical intuition for why the hail-mary zone emerges, and why it is a natural consequence of the optimisation problem faced by retirees. 

Consider a retiree who needs to fund a fixed level of consumption over a retirement horizon of \(T\) years. They consume one unit of wealth per year and begin retirement with \(w_0\) units of wealth. The retiree's objective is to minimise the expected number of years in which they are unable to fund their consumption, which we refer to as their bankruptcy density. Assuming for simplicity that wealth does not otherwise grow or decline, the number of years spent in bankruptcy is given by Equation \ref{bankruptcy_years}. 

\begin{equation} \label{bankruptcy_years} 
  D(w_0) = \max(T - w_0, 0) 
\end{equation}

Now suppose the retiree is offered a gamble. With probability \(p\), their wealth increases by \(A\%\), while with probability \(1-p\) they lose all remaining wealth. The resulting wealth after taking the gamble is therefore 

\begin{equation} \label{hail_mary_gamble} 
  W = \begin{cases} 
    (1+A)w_0 & \text{with probability } p,\\ 
    0 & \text{with probability } 1-p. 
  \end{cases} 
\end{equation} 

Consider the case where a successful gamble generates enough wealth to fully fund retirement: 

\begin{equation} \label{complete_rescue} 
  (1+A)w_0 \geq T. 
\end{equation} 

In this region, a successful gamble eliminates bankruptcy entirely, 

\begin{equation} 
  D_{\text{win}} = 0, 
\end{equation} 

while a failed gamble still results in 

\begin{equation} 
  D_{\text{lose}} = T. 
\end{equation} 

The expected bankruptcy density is therefore 

\begin{equation} \label{expected_bankruptcy_complete} 
  E[D_{\text{bet}}] = (1-p)T. 
\end{equation}

The retiree should take the gamble whenever 
\begin{equation} \label{complete_rescue_condition} 
  (1-p)T < T - w_0. 
\end{equation} 

Rearranging yields 
\begin{equation} \label{hail_mary_threshold} 
  w_0 < pT. 
\end{equation} 

Equation \ref{hail_mary_threshold} defines the boundary of the hail-mary zone. If current wealth can fund less than a fraction \(p\) of the remaining retirement horizon, then a gamble capable of fully rescuing retirement should be accepted, despite the possibility of total ruin. Conversely, once wealth exceeds this threshold the downside risk outweighs the potential benefit, because additional wealth beyond that required to fund retirement provides no further reduction in bankruptcy density. As in the case of the humanity-saving mission in the eponymous book, \textit{Project Hail Mary} \parencite{hailMary}, there exist a point at which the outlook is so dire that the only rational response is to take a high-risk gamble in the hope of a miraculous outcome. This is the hail-mary zone.
