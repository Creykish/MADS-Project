...
\usepackage{xcolor}
\usepackage{mdframed}
\newmdenv[leftmargin=10pt,rightmargin=10pt,linewidth=1pt,linecolor=gray,backgroundcolor=gray!12]{asidebox}
...
\subsection{Lifecyle Risk Measures}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../Figs/makinen_replication.png}
    \caption{Replication of the control matrix optimization method proposed by \textcite{Makinen2024} for the mean-variance case with one risky asset and no leverage.}
