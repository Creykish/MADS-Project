...
Table \ref{tab:glidepath_literature} summarises the key studies in the literature, including the lifecycle period studied, the glidepath shape recommended, the asset return modelling approach used, and the consumption/savings modelling approach used. The standard industry recommendation is that investors decrease their risk exposure as they age, continuing to reduce risk even after retirement (DE). This approach appears in investment textbooks \parencite[e.g][]{bodie2023investments, bengen1996asset} and is widely recommended by financial advisers and retirement planning tools \parencite{choi2022popular}. A review of U.S target date funds (TDFs) by \textcite{dolvin2010asset} find that most follow some form of declining-risk structure, often resembling a 120-minus-age equity rule. For a domestic example, take the SuperLife Age Steps allocation profile shown in Figure \ref{superlifeAllocation}. At one point a declining-risk glidepath was considered as part of potential reforms to the United States Social Security system under the George W. Bush administration \parencite[see][]{shiller2005life, shiller2006lifecycleSocialSecurity}.

However, much of the literature challenges the conventional wisdom of declining-risk glidepaths for retirees and even during the accumulation phase. \textcite{shiller2005life} critiqued the Bush-era proposal, arguing that declining-risk glidepaths often fail to outperform a 100\% equity strategy for workers. Further work by \textcite{estrada2014glidepath} supports the view that rising equity glidepaths can offer superior risk-adjusted returns for the accumulation phase. Other studies like \textcite{pfau2014rising} and \textcite{anarkulova2025beyond} support the conventional wisdom of declining-risk glidepaths for the accumulation phase, but come to different conclusions about the optimal glidepath shape during retirement. In particular, \textcite{pfau2014rising} find that rising equity in retirement can reduce both the probability and magnitude of portfolio failure, while \textcite{estrada2015retirement} find that declining equity in retirement is optimal. 

The debate around glidepath shape in retirement in particular is unresolved, and the literature is divided on whether rising equity, declining equity, or static allocations are optimal. For their part, the intuition of \textcite{BODIE1992427} concerning human capital has little to say about the post-retirement period, as human capital is exhausted at the point of retirement. In this sense, the post-retirement period is a different problem to the accumulation phase, and the optimal glidepath shape may differ between the two phases. The design of conventional rules or target-date funds often appears to be a mere extrapolation of the rule from the accumulation phase into retirement, without a clear theoretical or empirical basis for doing so. The best empirical evidence for the post-retirement period comes from \textcite{estrada2015retirement}, who find that declining equity in retirement is optimal across a wide range of countries and historical periods. However, this is in contrast to the findings of a number of other studies, including \textcite{pfau2014rising}, who find that rising equity in retirement can reduce both the probability and magnitude of portfolio failure. Even so, the case in favour of rising or declining equity in retirement is not clear-cut, with both \textcite{pfau2014rising} and \textcite{estrada2015retirement} finding that a static allocation is a robust baseline that performs nearly as well as the optimal dynamic glidepath in many cases. This suggests that the overall level of equity exposure may be more important than the precise shape of the glidepath, and that a simple static allocation may be a reasonable default for many investors.

This general conclusion is supported by \textcite{blanchett2007dynamic}, who find that static allocations have the lowest failure probability in all but one scenario (compared to 43 different declining-risk glidepaths). \textcite{anarkulova2025beyond} also find that a static allocation is nearly optimal across a wide range of scenarios, and that the optimal often resembles a static allocation with a brief tactical allocation to bonds at the point of retirement (u-shaped). \textcite{parker2024simple} also find that the optimal allocation is approximately flat after retirement. 

Whether rising or declining equity is optimal in retirement is therefore an open question, and the literature is divided on the issue. The reasons for this disagreement are complex, there is the choice of methodology for generating asset return scenarios, modelling risk tolerances, and modelling investor behaviour. On the asset return front, authors use many different approaches, including historical rolling periods, Monte Carlo simulation with IID returns, and other bootstrapping methods. There are also differences in how risk is measured and how investor behaviour is modelled, with some studies assuming fixed spending rules and others allowing for more flexible consumption patterns. As \textcite{anarkulova2025beyond} note, the tactical allocation to bonds at the point of retirement is only optimal under a fixed withdrawal rule, and disappears when spending flexibility is restored. This suggests that the optimal glidepath shape may depend on the specific assumptions made about investor behaviour and market conditions, and that there may not be a one-size-fits-all solution to the problem of retirement asset allocation.

Explainations supporting rising equity in retirement often focus on the idea of sequence-of-returns risk, which is the risk that an investor experiences a series of negative returns early in retirement, which can have a disproportionate impact on their portfolio and increase the likelihood of running out of money. As explained in \textcite{pfau2014rising}, starting with a conservative allocation at the point of retirement, the investor can limit the damage from a bad early period, while systematically accumulating equities at depressed prices through a downturn allows the portfolio to capture the eventual recovery when growth is most needed. \textcite{anarkulova2025beyond} point out however, that the sequence-risk mitigating bond allocations they observed in some of their glidepath optimisations were exaggerated when using return-generation methods that assumed IID returns (no time-series structure). When the time-series structure of returns is preserved, allocations to bonds are less optimal. They argue that this is because the long-horizon properties of bonds are much less favourable than their short-horizon statistics suggest. At 30-year horizons, bond variance \textit{increases} relative to the one-year level (variance ratio 2.30), whereas equity variance \textit{decreases} (variance ratio 0.75). In their dataset, bonds also carried a correlation of $-0.78$ against inflation, which they argue destroys real purchasing power in precisely the environments most harmful to retirees.

Both \textcite{anarkulova2025beyond} and \textcite{estrada2015retirement} find that 100\% equity is often optimal (or nearly optimal) throughout the lifecycle. Both these papers asset return generation methodologies that preserve the time-series structure of returns. As \textcite{estrada2015retirement} notes, while proponents of rising equity in retirement often cite sequence-of-returns risk as a rationale for their findings, the empirical evidence that sequence risk actually materially affects retirement outcomes is limited. \textcite{anarkulova2025beyond} further note that sequence risk appears to be exaggerated by IID return-generation methods which might ignore the mean-reverting nature of equity returns. In this sense, the support outlined in \textcite{pfau2014rising} for rising equity in retirement may be overstated by their use of IID return-generation methods.
...
\begin{table}[htbp]
    \centering
    \small
    \caption{Key glidepath studies in the lifecycle asset allocation literature.}
    \label{tab:glidepath_literature}
    \begin{tabular}{p{2.3cm}p{3.0cm}p{3.0cm}p{3.0cm}p{4cm}}
        \toprule
        Citation & Lifecycle Period Studied & Glidepath shape recommended & Asset return modelling & Consumption/Savings Modelling \\
        \midrule
          \textcite{merton1969lifetime} 
          & Decumulation only
          & Static risky share (constant equity weight) 
          & IID lognormal returns 
          & Fixed proportion of wealth consumed 
        \\
          \textcite{BODIE1992427} 
          & Accumulation only
          & Declining equity
          & Lifecycle model with human capital and labour income 
          & Endogenous consumption and saving 
        \\
          \textcite{shiller2005life} 
          & Accumulation only
          & Flat is better than declining equity
          & Historical long-run US asset returns 
          & Dollar contributions following Social Security guidelines
        \\
          \textcite{estrada2014glidepath, estrada2015retirement}
          & Accumulation \parencite{estrada2014glidepath} and decumulation \parencite{estrada2015retirement}
          & Inverted U-shape (increase equity during accumulation, then decline in retirement) 
          & Historical rolling periods across 19 countries and the world, 1900--2009 
          & Fixed real savings and withdrawals
        \\
          \textcite{pfau2014rising} 
          & Accumulation and decumulation
          & U-shaped overall: declining during accumulation, rising in retirement 
          & Monte Carlo IID lognormal returns; 10,000 simulations 
          & Fixed real withdrawals based on the initial maximum sustainable withdrawal rate (MWR).
        \\
          \textcite{blanchett2007dynamic} 
          & Decumulation only
          & Static allocations often best; 60/40 or 100/0 depending objective 
          & Bootstrapped monthly data, 1927--2006. Does not preserve time-series structure of returns
          & Varying fixed real withdrawals based on inital portfolio value and retirement horizon
        \\
          \textcite{parker2024simple} 
          & Accumulation and decumulation
          & Declining lifecycle path, but broadly flat after retirement; around 60\% equity at retirement 
          & Reinforcement learning with autocorrelated returns and health/longevity shocks 
          & Endogenous spending and shocks. 
        \\
          \textcite{anarkulova2025beyond} 
          & Accumulation and decumulation
          & Approximately 100\% equity throughout life; tactical bond spike only at retirement (U-shape) under fixed withdrawal assumptions
          & Block bootstrap preserving some time-series and cross-sectional structure of historical returns
          & Fixed and flexible spending rules
        \\
        \bottomrule
    \end{tabular}
\end{table}

Taken together, the literature suggests that the optimal glidepath is highly sensitive to the intersection of the return-generation methodology, the risk measure used, and the spending rule assumed. The literature is divided on whether rising or declining equity is optimal in retirement, and there is no clear consensus on the best approach. However, there is some evidence that static allocations can be nearly optimal across a wide range of scenarios, and that the overall level of equity exposure may be more important than the precise shape of the glidepath. This suggests that a simple static allocation may be a reasonable default for many investors, particularly when combined with flexible spending rules that allow for adjustments based on changing circumstances.
...
Equation \ref{hail_mary_threshold} defines the boundary of the hail-mary zone. If current wealth can fund less than a fraction \(p\) of the remaining retirement horizon, then a gamble capable of fully rescuing retirement should be accepted, despite the possibility of total ruin. Conversely, once wealth exceeds this threshold the downside risk outweighs the potential benefit, because additional wealth beyond that required to fund retirement provides no further reduction in bankruptcy density. As in the case of the eponymous book \parencite{hailMary}, there exist a region where the outlook of the retiree is so dire that the only rational response is to take a high-risk gamble in the hope of a miraculous outcome. This is the hail-mary zone.
