...
Given that Kiwisaver is relatively new, having been introduced in 2007, much of the current concerns of retirees in New Zealand are likely to shift as more people enter retirement with significant KiwiSaver balances. Currently, 40 percent of New Zealanders aged 65 rely entirely on New Zealand Superannuation for their retirement income, while 20 percent only have only a small amount of savings in addition to New Zealand Superannuation \parencite{taao2022nzSuperReliance}. As more people enter retirement with significant KiwiSaver balances, this demography is likely to shift. Additionally, the government is already taking steps to increase KiwiSaver contributions, which will further increase the amount of wealth that future retirees have in their KiwiSaver accounts.

In this sense, it is likely that the New Zealand retirement system will increasingly resemble the Australian system, which has a retirement system based on a combination of a means-tested public pension and a mandatory private savings scheme (superannuation). However, the Australian goes significantly further than New Zealand in encouraging private savings, with a mandatory contribution rate of 12 percent of income, compared to New Zealand's voluntary contribution system, and with a significantly higher contribution rate for those who do choose to contribute \parencite{atoSuperGuaranteePercentage, swoboda2014superannuationChronology}. 

\subsection{Consumption in Retirement}

The ``retirement consumption puzzle'' refers to the repeated empirical finding that expenditure often drops when people retire, despite standard life-cycle and permanent-income models predicting relatively smooth consumption over time. In the canonical framework, households accumulate during working life and then gradually decumulate in retirement while maintaining living standards \parencite{ando1963lifecycleHypothesis}. In practice, many households appear to reduce spending at retirement and draw down wealth more slowly than these models would imply. This combination, both retirees spending less and drawing down wealth more slowly, is puzzling because it suggests a more complex set of dynamics than traditional models of consumption smoothing would predict.



The evidence also suggests that this is not a single mechanism, but a combination of effects. One explanation is mechanical: some spending naturally falls when work ends. Commuting, work clothing, and purchased meals decline, which can generate a measured drop in expenditure even without a meaningful fall in welfare \parencite{aguiar2008deconstructing, battistin2007retirementPuzzle}. Relatedly, if retirees substitute market purchases with home production, observed expenditure may fall while underlying consumption remains closer to smooth-path predictions \parencite{becker1965allocation, hurd2003retirementPuzzle}.

Another channel is heterogeneity in retirement pathways. Households that retire unexpectedly, especially after adverse health shocks, can experience sharper spending adjustments than households that retire as planned \parencite{barrett2010involuntary}. This helps explain why average effects can mask substantial cross-household dispersion in retirement outcomes.

Cross-country comparisons reinforce the importance of institutional context. \textcite{banks2016lifeCycle} show that spending profiles at older ages differ materially between the US and UK, with medical expenditure differences explaining much of the gap. This is directly relevant for interpretation in New Zealand, where public pension design and healthcare financing differ from both countries and therefore shape the extent to which retirement expenditure paths reflect preference changes versus institutional constraints.

Evidence from Japan also points to composition effects rather than a universal collapse in living standards at retirement. \textcite{stephens2012impact} find declines concentrated in lower-income households and in categories such as food and work-related items, while average retirement effects are more muted. Taken together, the literature suggests that a simple ``retirement means consumption drops'' narrative is incomplete: household resources, health, institutional settings, and expenditure composition all matter for observed spending dynamics.
...
However, some international studies can help shed light on this question. 
...
\subsection{Methods for Simulating Lifetime Wealth Trajectories}
